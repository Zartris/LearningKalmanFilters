...
struct SimulationParams
{
    ...
    SimulationParams()
        : profile_name(""),
          ...
          gyro_enabled(false), gyro_update_rate(10.0), gyro_noise_std(0.001), gyro_bias(0.0),
          imu_enabled(false), imu_update_rate(10.0), imu_noise_std(0.001), imu_bias(0.0),
