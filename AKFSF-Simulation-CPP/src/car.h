...
struct VehicleState
{
    double x, y, psi, V, ax, ay;
    double yaw_rate, steering;
    VehicleState() : x(0.0), y(0.0), psi(0.0), V(0.0), ax(0.0), ay(0.0), yaw_rate(0.0), steering(0.0) {}
    VehicleState(double setX, double setY, double setPsi, double setV) : x(setX), y(setY), psi(setPsi), V(setV), ax(0.0), ay(0.0), yaw_rate(0.0), steering(0.0) {}
    VehicleState(double setX, double setY, double setPsi, double setV, double setAx, double setAy, double setPsiDot, double setSteering) : x(setX), y(setY), psi(setPsi), V(setV), ax(setAx), ay(setAy), yaw_rate(setPsiDot), steering(setSteering) {}
};
...
public:
    ...
    void update(double dt)
    {
        ...
        double ax = accel * cosPsi;
        double ay = accel * sinPsi;
        ...
        m_current_state = VehicleState(x, y, psi, vel, ax, ay, psi_dot, steer);
    }
